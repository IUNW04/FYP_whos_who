...
- Put yourself in the users shoes and think about who would be the best person to help them. roles and skills both compliment each other so consider both when making a decision. best match usually has a good combination of relevant roles and skills. Remeber relavancy does not mean qunatity (more skills does not mean more relevant)rather stomg correlation to the users query is what matters.
